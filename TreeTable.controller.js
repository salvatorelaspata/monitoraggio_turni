sap.ui.controller('sap.ui.bki.monitoraggio.turni.TreeTable', {
   onInit: function () {
   ...
   */
   ...
   onSelectDate: function () {
      this._DialogSelectionDate = sap.ui.xmlfragment(
         'sap.ui.bki.monitoraggio.turni.DialogDate',
         this
      );
   ...
   onSubmitDialog: function (oEvent) {
      this.oPersonalizationDialog = sap.ui.xmlfragment(
         'sap.ui.bki.monitoraggio.turni.DialogFabbisogni',
         this
      );
      var dataModel = this.getView().getModel('dataSource');
      var dataSource = dataModel.getData();
      dataSource.fabbisogni = [
         {
            Raggruppamento: 'Raggruppamento 1',
         ...
         {
            Raggruppamento: 'Raggruppamento 2',
            DataInizio: '22-01-2020',
            DataFine: '22-03-2020',
            Tipologia: ['Feriale', 'Festivo'],
            Orario: '14-18',
         ...
         {
            Raggruppamento: 'Raggruppamento 3',
            DataInizio: '22-01-2020',
            DataFine: '22-03-2020',
   ...
   onRaggruppamentoDialog: function (oEvent) {
      this._DialogRaggruppamento = sap.ui.xmlfragment(
         'sap.ui.bki.monitoraggio.turni.DialogRaggruppamenti',
         this
      );
   ...
   handleSelectDialogPress: function (oEvent) {
      ...
      this._oDialogSelectUser = sap.ui.xmlfragment(
         'sap.ui.bki.monitoraggio.turni.DialogUtenti',
         this
      );
      this._oDialogSelectUser.setModel(this.getView().getModel('dataSource'));
   ...
   onDialogAddRaggruppamenti: function () {
      ...
      this._oDialog = sap.ui.xmlfragment(
         'sap.ui.bki.monitoraggio.turni.DialogAddRaggruppamento',
         this
      );
